  ...
  await yargs(rawArgs)
    ...
    .command(
      ...
      (y: Argv) => y
        ...
        .option('runtime-mode', { type: 'string', choices: ['tmux', 'pty-ts', 'pty-rust', 'pty'], describe: 'Runtime backend to use' })
    ...
    .command(
      ...
      (y: Argv) => y
        ...
        .option('runtime-mode', { type: 'string', choices: ['tmux', 'pty-ts', 'pty-rust', 'pty'], describe: 'Set runtime backend' })
