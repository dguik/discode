  ...
  await yargs(rawArgs)
    ...
    .command(
      ...
      (y: Argv) => y
        ...
        .option('runtime-mode', { type: 'string', describe: 'Runtime backend to use (tmux|pty-rust; pty/pty-ts aliases supported)' })
    ...
    .command(
      ...
      (y: Argv) => y
        ...
        .option('runtime-mode', { type: 'string', describe: 'Set runtime backend (tmux|pty-rust; pty/pty-ts aliases supported)' })
